...
import AdminBookingRequestRow from '../components/AdminBookingRequestRow';

export default function VenueOwnerDashboard() {
  const requests: React.ComponentProps<typeof AdminBookingRequestRow>[] = [
    {
      initials: "AC",
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-surface-container-high dark:divide-inverse-surface">
                {requests.map((req, i) => (
                  <AdminBookingRequestRow key={i} {...req} />
                ))}
              </tbody>
            </table>
          </div>
